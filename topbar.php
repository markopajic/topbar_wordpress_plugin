...
/*
Plugin Name: Top Bar by Marko Pajic
Plugin URI: http://wordpress.org/plugins/
Description: Top Bar on top of Website to say welcome to user.
Author: Marko Pajic
Version: 1.0.0
Author URI: 
*/
...
echo '<style>
            ...
            .top-bar-wrapper label {font-size: 3em; display: block; line-height: normal; margin-bottom: 30px; font-weight: bold}
            .top-bar-wrapper input {color:#666; width: 100%; padding: 30px; font-size: 3em}
            .top-bar-wrapper .button {font-size: 2em; text-transform: uppercase; background: rgba(59,173,227,1); background: linear-gradient(45deg, rgba(59,173,227,1) 0%, rgba(87,111,230,1) 25%, rgba(152,68,183,1) 51%, rgba(255,53,127,1) 100%); border:none}
